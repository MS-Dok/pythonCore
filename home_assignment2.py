...
"""
print("Word \"better\" appears "+str(py_zen.count("better"))+" times")
print("Word \"never\" appears "+str(py_zen.count("never"))+" times")
print("Word \"is\" appears "+str(py_zen.count("is"))+" times")
